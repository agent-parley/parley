...
func (s *Server) projectSettingsData(r *http.Request, project store.Project) (web.ProjectSettingsData, error) {
	...
	agentProfiles, err := s.projectAgentProfileEditorData(r, project, "", "")
	if err != nil {
		return web.ProjectSettingsData{}, err
	}
	...
	return web.ProjectSettingsData{Project: project, Rules: rules, Preferences: preferences, AgentProfiles: agentProfiles, Memory: memoryExport, Notifications: notificationSettings, Center: center, CSRF: csrf, Title: "Parley · " + project.Name + " Settings"}, nil
}
