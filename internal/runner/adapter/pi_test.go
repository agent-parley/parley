...
func TestPiPrepareConversationUsesReadOnlyCommittedSnapshotAndWorkspace(t *testing.T) {
	...
	disp.Input = map[string]any{
		...
		"workflow_template_selection": map[string]any{
			...
			"selectable_templates": []map[string]any{
				{"id": "balanced_pr_delivery", "name": "Balanced PR Delivery", "sources": []string{"default", "predefined_floor"}},
				{"id": "quick_fix_delivery", "name": "Quick Fix Delivery", "sources": []string{"small_fix", "predefined_floor"}},
			},
		},
